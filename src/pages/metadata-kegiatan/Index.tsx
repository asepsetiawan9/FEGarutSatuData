...
const Index = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await http().get('/metadata');
  ...
  return (
    ...
    >
      <BreadcrumbsWrapper>
        <div className="px-4">
          <h1 className="font-bold">Metadata Kegiatan</h1>
          ...
          <div className="my-4 flex gap-4">
            <div className="relative w-full">
              ...
              <input
                ...
                placeholder="Cari Judul Metadata ..."
          ...
          <div className="flex flex-row justify-between ">
            <span className="pt-2.5 text-sm font-bold">
              {jumlahData || '0'} Jumlah Metadata kegiatan
            </span>
            ...
            <div className="space-y-4">
              {paginatedDataset.length === 0 ? (
                ...
                paginatedDataset.map((item) => (
                  <Link
                    key={item.id}
                    href={`/metadata-kegiatan/${item.slug}`}
